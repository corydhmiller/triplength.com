...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
	return (
		<div className="max-w-[1240px] w-full mt-xl mb-xxl px-6 z-10">
			<div className="p-xl bg-white border border-border-color rounded-lg shadow-md shadow-primary-blue max-w-[600px] mx-auto mt-xl" role="alert" aria-live="assertive">
				<h2 className="text-[1.5rem] font-bold text-primary-black mb-md">Something went wrong</h2>
				<p className="text-text-muted mb-md">We encountered an unexpected error. Please try again.</p>
