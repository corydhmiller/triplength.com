	...
	return (
		<div className="max-w-[1240px] w-full mt-xl mb-xxl px-6 z-10">
			<div className="p-xl bg-white border border-white-soft rounded-lg shadow-md shadow-primary-blue max-w-[600px] mx-auto mt-xl" role="alert" aria-live="assertive">
				<h2 className="text-[1.5rem] font-bold text-black mb-md">Something went wrong</h2>
				...
				<button onClick={() => reset()} className="px-lg py-sm bg-primary-blue text-white rounded-md hover:bg-black transition-all font-semibold">
					Try Again
				</button>
			</div>
		</div>
