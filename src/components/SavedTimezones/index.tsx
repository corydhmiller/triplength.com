			...
			<div className="flex flex-wrap gap-xs">
				{timezones.map(tz => (
					<button
						...
						type="button"
						onClick={() => onSelect(tz)}
						className="px-xs py-[0.2rem] bg-white text-primary-black text-[0.8rem] rounded border border-white-soft hover:border-primary-blue hover:text-primary-blue transition-all"
